...
class GroundingEvaluator:
    ...
    def evaluate(self, end_points, prefix):
        ...
        return self.evaluate_bbox_by_contrast(end_points, prefix)
        ...
        for bid in range(len(positive_map)):
            ...
            for t in self.thresholds:
                ...
                for k in self.topks:
                    ...
                    if (prefix == 'last_' and t == 0.5 and k == 1):
                        outputs.append([found, pbox[0]])
...
class GroundingGTEvaluator:
    ...
    def print_stats(self):
        ...
        for field in ['easy', 'hard', 'vd', 'vid', 'unique', 'multi']:
            ...
            print(field, self.dets[field] / self.gts[field], self.dets[field], self.gts[field])
        return self.dets, self.gts
